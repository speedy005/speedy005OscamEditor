#!/bin/bash
##setup command=wget -q "--no-check-certificate" https://raw.githubusercontent.com/speedy005/OscamEditor/refs/heads/main/installer.sh -O - | /bin/sh
...
echo ""
echo "#########################################################"
echo "#          speedy005pOscamEditor INSTALLED SUCCESSFULLY  #"
